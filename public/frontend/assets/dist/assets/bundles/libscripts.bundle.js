!(function (e, t) {
      ...
      (g = ae.select =
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === u.length)) {
            ...
            for (
              r = K.needsContext.test(e) ? 0 : o.length; r-- && ((s = o[r]), !_.relative[(a = s.type)]);
  ...
  function Oe(n, i, r, o) {
    ...
    if (
      ...
      if (a)
        for (
          c = s[s.length - 1].ownerDocument, T.map(s, De), u = 0; u < a; u++
        )
          (l = s[u]),
            fe.test(l.type || "") &&
  ...
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (
            o = o || pe(e), s = s || pe(u), i = 0, r = o.length; i < r; i++
          )
            Le(o[i], s[i]);
        else Le(e, u);
      return (
    ...
    cleanData: function (e) {
      for (
        var t, n, i, r = T.event.special, o = 0; void 0 !== (n = e[o]); o++
      )
        if (V(n)) {
          if ((t = n[Q.expando])) {
            if (t.events)
    ...
    T.each({
      ...
      function (e, s) {
        T.fn[e] = function (e) {
          for (
            var t, n = [], i = T(e), r = i.length - 1, o = 0; o <= r; o++
          )
  ...
  (T.Animation = T.extend(gt, {
    ...
    tweener: function (e, t) {
      for (
        var n,
        i = 0,
        r = (e = b(e) ? ((t = e), ["*"]) : e.match(P)).length; i < r; i++
      )
        (n = e[i]),
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              ((i = r[s]).selected = -1 < T.inArray(T.valHooks.option.get(i), o)) &&
                (n = !0);
  ...
  (function (e, t) {
          ...
          (n ||
            (function (e) {
              ...
              if (n && We(e) && "fixed" === Qe(e).position)
                return null;
              for (
                var i = Ge(e); We(i) && ["html", "body"].indexOf($e(i)) < 0;
            ...
            forceUpdate: function () {
              if (!l) {
                ...
                if (Mt(t, e)) {
                  ...
                  for (
                    var n, i, r, o = 0; o < s.orderedModifiers.length; o++
                  )
                    !0 !== s.reset ?
    ...
    var $t = qt({
      defaultModifiers: [ht, Nt, dt, ze, K, St, jt, lt, Ot]
    }),
      Rt = Object.freeze({
        __proto__: null,
        popperGenerator: qt,
